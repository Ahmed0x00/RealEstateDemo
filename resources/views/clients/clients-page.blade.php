...
.see-more, .see-less {
    padding: 0;
    margin: 0;
    color: grey; /* Bootstrap primary color */
    cursor: pointer;
...
<div class="container-fluid">
    <div class="row">
        <div class="col-12 col-md-10 offset-md-2 table-container bg-white shadow px-3">
            <!-- Search Bar and Add Client Button Row -->
            <div class="search-group">
                <!-- Search Bar with Icon -->
                <div class="input-group search-bar">
                    <span class="input-group-text"><i class="fas fa-search"></i></span>
                    <input type="text" class="form-control" id="searchInputClient" placeholder="Search For Client name">
                </div>

                <!-- Add Client Button -->
                <a href="#" class="btn btn-primary add-btn" id="addClient">Add Client</a>
            </div>
            ...
            <div class="table-responsive">
                <table class="table table-striped table-hover" id="clientTable">
                    <thead class="table-light">
                        <tr>
                            <th id="ClientIdColumn">ID</th>
                            <th id="ClientNameColumn">Name</th>
                            <th id="ClientEmailColumn">Email</th>
                            <th id="ClientPhoneColumn">Phone</th>
                            <th id="ClientActionsColumn">Actions</th>
                            <th id="updateDeleteColumnClient">Update/Delete</th>
                        </tr>
                    </thead>
                    <tbody id="clientTableBody">
                        <tr>
                            <td colspan="6" class="text-center no-records"><span>There are no recorded Clients</span></td>
                        </tr>
                    </tbody>
                </table>
            </div>
